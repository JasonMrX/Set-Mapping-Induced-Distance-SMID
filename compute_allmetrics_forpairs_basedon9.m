function compute_allmetrics_forpairs_basedon9(ConsensusPairFile, AllMetrics_SimFile)
...
%  compute_allmetrics_forpairs_basedon9('ConsensusPairs.dat', 'AllMetrics_Sim_for9.dat')
 ...
 for n=1:Npairs
     % process sim-group
         ...
         [success hist_IS mDistPixel mDistDCT pmse] = GreedyComputationISmai9(filename1, filename2) ;
