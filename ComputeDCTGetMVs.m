function  [mDistDCT, mDistDCTEntropy, motionVectors, success] = ComputeDCTGetMVs(filename1, filename2)
...
%     ================= mv entropy ====================
    ...
    for i = 1 : size(idx, 1)
        ...
        minCoef = min([DCTImage1(:); DCTImage2(:)]);
        [~, Cedges, ~] = DoEdmondMatch(floor(DCTImage1 - minCoef), floor(DCTImage2 - minCoef), 1) ;
