function DisplayAllMetric_basedon8
...
% 4: pmse, Nmatch1, VScore1,  Nmatch2, VScore2
  ...
  if 1
      ...
      figure
      Sim_DCTm    = hist(SimMetric   (SelectSet1,2), 0:30*1.25:2000*1.25);
      Notsim_DCTm = hist(NotsimMetric(SelectSet2,2), 0:30*1.25:2000*1.25);
      ax = 0:30*1.25:2000*1.25 ;
      plot(ax, Sim_DCTm, 'g-');
      hold on 
      plot(ax, Notsim_DCTm, 'r-');
      legend('Similar pairs', 'Not-similar pairs');
